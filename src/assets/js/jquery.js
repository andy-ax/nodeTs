/*!
 * jQuery Compat JavaScript Library v3.0.0-pre 1eedf0e9ea4dc2d12edf28e77b33ae23de01af3b
 * http://jquery.com/
 *
 * Includes Sizzle.js
 * http://sizzlejs.com/
...
var
	version = "3.0.0-pre 1eedf0e9ea4dc2d12edf28e77b33ae23de01af3b",

	// Define a local copy of jQuery
	jQuery = function( selector, context ) {
		// The jQuery object is actually just the init constructor 'enhanced'
		// Need init if jQuery is called (just allow error to be thrown if not included)
		var a = new jQuery.fn.init( selector, context );
		return a;
	},
...
// 原型 通过jquery.fn.方法()调用方法 jquery.fn
// 对象字面量
jQuery.fn = jQuery.prototype = {
	...
	//将类数组元素组合(如通过getElementByTagName获取到的元素组合)变为数组
	toArray: function() {
		// call的使用方法     obj1.call(obj2,arg1-argN)； 将obj1放入obj2内执行一次 arg是obj1的参数 obj2是壳
		// obj2将继承obj1内的全部属性与方法
		return slice.call( this );
	},

	// Get the Nth element in the matched element set OR
	// Get the whole matched element set as a clean array
	// jQuery.prototype['toArray'] 等价于 jQuery.prototype.toArray
	get: function( num ) {
		return num != null ?

			// Return just the one element from the set 根据数字返回该位置的元素
			( num < 0 ? this[ num + this.length ] : this[ num ] ) :

			// Return all the elements in a clean array 否则返回全部元素数组
			slice.call( this );
	},
	...
	// apply同call arg为参数数组
	// argyments 是内部属性 为function内的参数数组，必须在局部作用域才生效
	slice: function() {
...
jQuery.extend({
	...
	globalEval: function( data ) {
		...
		// insertBefore在已有子节点的父元素中的指定子元素前插入新的子节点 父节点.insertBefore(要插入的节点,指定的节点)
